...
dotenv.config();
const yourUsername = process.env.SECRET_USERNAME;
const yourPassword = process.env.SECRET_PASSWORD;
const yourAPIKey = process.env.SECRET_APIKEY;
const yourBearerToken = process.env.SECRET_BEARERTOKEN;
